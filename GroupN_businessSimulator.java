...
=======
    ...
    if (itemIndex == 2 && qty >= 10) {
        total = total - 500; // UGX 500 flat off
    }

    if (itemIndex == 3 && qty >= 3) {
        total = total * 0.90; // 10% off
    }
    // Data Bundle (itemIndex 1) has no discount
...
>>>>>>> 1203da9d0298f2276b7a64a8ebc3f6fea5eb90f8
